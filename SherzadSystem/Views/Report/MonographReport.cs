...
{
    public partial class MonographReport : XtraUserControl
    {
        public MonographReport()
        {
            InitializeComponent();
            ...
            GridMonographs.DataSource = Controller.Monograph.GetMonographsReport();
        ...
        private void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (Valid())
            {
                GridMonographs.DataSource = Controller.Monograph.GetMonographsReport(StartDate.DateTime, EndDate.DateTime, ItemsList.ToArray());
        ...
        bool Valid()
        {
            ...
            {
                SelectPerson.ErrorText = "محصل مو نه دی انتخاب کړئ";
                IsTrue = false;
            }
            else
            {
